...
ScatterDataModifier::ScatterDataModifier(Q3DScatter *scatter, cellVectors& target)
    : m_graph(scatter),
      m_fontSize(40.0f),
...
void ScatterDataModifier::addData(cellVectors& target)
{
    ...
    vector3d R;
            ...
            R(2) = 0.0;
            //R(2) = target[i](2);
                ptrToDataArray->setPosition(QVector3D(R(0),R(2),R(1)));
                ptrToDataArray++;
    }
    //! [6]
#endif
